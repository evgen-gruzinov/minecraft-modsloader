  ...
  jQuery.fn.extend({
    ...
    rotate(parameters) {
      ...
      for (let i = 0, i0 = this.length; i < i0; i++)	{
        ...
        if (typeof element.Wilq32 === 'undefined') { returned.push($($(element).ImageRotate(parameters))); } else { element.Wilq32.PhotoEffect._handleRotation(parameters); }
      }
      return returned;
    },
  });
  ...
  Wilq32.PhotoEffect.prototype = {
    ...
    _Loader: (function ()	{
      ...
      return function (parameters)		{
        ...
        const _widthMax = Math.sqrt((this._height) * (this._height) + (this._width) * (this._width));
